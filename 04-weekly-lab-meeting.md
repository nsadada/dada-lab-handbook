...
layout: default
parent: Training and lab culture
nav_order: 2
---
...
- create a regular opportunity to identify barriers and troubleshoot before problems become more difficult to address
- help lab members communicate their work clearly and receive constructive feedback
- build the habit of engaging critically with scientific evidence, reasoning, and interpretation
- provide an intentional, cumulative professional-development curriculum aligned with the lab’s annual strategic goals
...
The first portion of the meeting is dedicated to maintaining shared awareness, orienting the group to current priorities, and supporting timely communication across the lab. It generally includes:
**Welcome and brief check-ins.** We begin by coming together as a team and briefly orienting to the week. Check-ins do not require personal disclosure. They help establish presence, identify immediate constraints when relevant, and reinforce that science is carried out by people working within real professional and personal contexts.
**High-level updates.** Updates may include relevant institutional, funding, administrative, facility, safety, personnel, or lab-level information. This portion of the meeting helps ensure that members understand the broader environment in which the lab operates and are aware of upcoming deadlines, changes, opportunities, or shared needs.
**Agenda, meeting focus, and expectations.** The meeting agenda identifies the planned focus for the scientific or professional-development portion of the session, clarifies preparation expectations, and notes decisions or discussions requiring particular attention.
...
Roundtable updates should generally address:
- what was completed or learned since the previous meeting
- immediate priorities or planned work for the week
- [barriers, uncertainties, or troubleshooting needs](#part-i-lab-coordination-and-roundtable)
- decisions or feedback needed from the group or Nsa
- relevant shared-resource, scheduling, sample, colony, equipment, or collaboration needs

Research rarely proceeds exactly as planned. Questions, unexpected outcomes, mistakes, constraints, and failures are normal components of scientific work. They should be raised early enough for the lab to respond constructively.
...
- discussion of a research method, analytic approach, or conceptual problem
- practice for a poster, seminar, qualifying exam, proposal, or other presentation, or
- a structured discussion of a professional-development topic
This portion of the meeting is informed by the Oxford tutorial approach. Lab members are expected to prepare in advance, engage seriously with the assigned material or topic, articulate their reasoning, ask thoughtful questions, and revise their views when the evidence or logic warrants it.
...
3.	What evidence is offered in support?
4.	Does the evidence adequately support the conclusion? What inference connects the evidence to the claim?
5.	What assumptions, limitations, confounders, or alternative explanations should be considered?
6.	What information, experiment, analysis, or action would strengthen, challenge, or refine the conclusion?
This framework applies beyond journal articles. It can be used to evaluate experimental designs, preliminary data, project decisions, professional dilemmas, institutional practices, and mental models that may guide how we approach our work.
...
- understanding different lab roles and how they support one another
- decision-making frameworks and mental models, including useful “razors” for clarifying complex problems
...
- ask questions when something is unclear or unsupported
- provide feedback that is specific, respectful, and useful
- listen actively and make room for others to contribute
- communicate barriers, or resource needs early, and
- treat discussion as an opportunity to develop stronger reasoning, not merely to demonstrate what one already knows

The weekly meeting is one of the main ways we build continuity in the lab. It helps preserve shared knowledge, ensures that work does not become isolated within individuals, and creates a record of how the lab thinks, learns, adapts, and moves forward together.
