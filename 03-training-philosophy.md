---
title: Nsa's philosophy and approach to training
layout: default
parent: Training and lab culture
nav_order: 1
---

# **Overarching philosophy: scaffolding, not handholding nor hands-off**
...
# **My role**
My role is to set the scientific direction of the lab, help lab members develop the scientific, technical, and professional skills needed to develop into independent scientists. This includes providing guidance and feedback, helping to identify barriers and think through challenges, supporting lab members as they build confidence and take increasing ownership of their work, and ensuring that work remains aligned with the lab’s scientific, training, and programmatic goals.
...
- complete requisite foundational trainings that are provided during the onboarding process and throughout the training period
- actively and consistently use and apply the career development tools and structures that we establish together
